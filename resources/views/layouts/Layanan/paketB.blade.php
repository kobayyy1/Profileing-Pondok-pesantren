...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
    ...
    {{-- Hero Section --}}
    <div class="relative bg-gradient-to-r from-blue-700 via-indigo-700 to-blue-800 overflow-hidden">
        ...
        <div class="relative max-w-5xl mx-auto px-6 py-16 text-center">
            <a href="{{ route('layanan') }}" class="inline-flex items-center gap-2 text-blue-100 hover:text-white text-sm font-medium mb-8 group transition-colors">
            ...
            <p class="text-blue-100 text-lg font-light max-w-xl mx-auto leading-relaxed">
                Program Pendidikan Kesetaraan setara SMP berbasis kurikulum Islami Teknoprenuer
            </p>
        </div>
    </div>
    ...
    <div class="max-w-5xl mx-auto px-6 py-12 space-y-12">
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-blue-100 overflow-hidden">
            <div class="flex items-center gap-4 bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-5">
            ...
            <div class="px-8 py-7 space-y-4">
                <p class="text-gray-700 leading-relaxed text-base">
                    <span class="font-semibold text-blue-700">Paket B Setara SMP</span> adalah Program Pendidikan Kesetaraan (Paket) Pendidikan Non Formal yang setara dengan SMP. Program ini merupakan jalur alternatif dari Kementerian Pendidikan dan Kebudayaan bagi masyarakat maupun siswa-siswi yang putus sekolah atau siapapun yang tidak berkesempatan mendapatkan pendidikan formal karena keterbatasan sosial, ekonomi, waktu, kesempatan, dan geografi.
                </p>
                <p class="text-gray-700 leading-relaxed text-base">
                    Di samping itu, ada juga siswa dan siswi yang mengikuti program ini dengan kesibukan lain dalam hal profesi sebagai <span class="font-semibold text-blue-700">Atlet, wirausahawan, karyawan, maupun pegawai</span>. Program ini juga cocok bagi mereka yang tidak bisa berkonsentrasi di lingkungan sekolah yang ramai, serta murid-murid home schooling.
                </p>
                <p class="text-gray-700 leading-relaxed text-base">
                    Program pendidikan kesetaraan Paket B Setara SMP adalah penyempurnaan program Ujian Persamaan yang sebelumnya pernah diberlakukan. Siswa yang ingin mengikuti <span class="font-semibold text-blue-700">Ujian Nasional Pendidikan Kesetaraan (UNPK)</span> harus lebih dulu ikut kegiatan belajar yang diadakan Pusat Kegiatan Belajar Masyarakat (PKBM).
                </p>

                {{-- Kegunaan Ijazah --}}
                <div class="mt-2 p-5 rounded-2xl bg-blue-50 border border-blue-100">
                    <p class="text-sm font-semibold text-blue-700 mb-3 flex items-center gap-2">
                        ...
                        Kegunaan Ijazah Paket B
                    </p>
                    <div class="grid sm:grid-cols-2 gap-2">
                        @foreach(['Melamar pekerjaan', 'Melanjutkan ke SMA / SMK / MA Negeri', 'Melanjutkan ke SMA / SMK / MA Swasta', 'Setara dengan Ijazah SMP resmi'] as $guna)
        ...
        <div>
            ...
            <div class="grid gap-6">
                ...
                <div class="grid sm:grid-cols-3 gap-4">
                    @php
                        $targets = [
                            ['num' => '3', 'icon' => '📖', 'title' => 'Hafalan 3 Juz', 'desc' => 'Mempunyai hafalan minimal 3 juz Al-Qur\'an', 'color' => 'from-violet-500 to-purple-600'],
                            ['num' => '4', 'icon' => '✅', 'title' => 'Program Selesai', 'desc' => 'Menyelesaikan seluruh program pembelajaran', 'color' => 'from-blue-500 to-cyan-600'],
                            ['num' => '5', 'icon' => '🚀', 'title' => 'Projek Interprenuer', 'desc' => 'Membuat projek interprenuer sebagai syarat kelulusan', 'color' => 'from-rose-500 to-pink-600'],
                        ];
                    @endphp
        ...
        {{-- Persyaratan --}}
        <div class="bg-white rounded-3xl shadow-xl border border-blue-100 overflow-hidden">
            <div class="flex items-center gap-4 bg-gradient-to-r from-indigo-600 to-blue-700 px-8 py-5">
                <div class="flex-shrink-0 w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <p class="text-blue-100 text-sm">Program Paket B Setara SMP – PKBM Rekan Indonesia</p>
                </div>
            </div>
            <div class="px-8 py-7">
                <div class="grid sm:grid-cols-2 gap-4">
                    ...
                    <div class="flex items-start gap-3 p-4 rounded-xl bg-indigo-50 border border-indigo-100 hover:border-indigo-300 transition-colors">
                ...
                <div class="mt-6 p-5 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 flex flex-col sm:flex-row items-center gap-4">
                    <div class="text-white flex-1">
                        <p class="font-bold text-base">Siap mendaftar?</p>
                        <p class="text-blue-100 text-sm mt-0.5">Hubungi kami untuk informasi lebih lanjut tentang program Kejar Paket B</p>
                    </div>
                    <a href="#" class="flex-shrink-0 bg-white text-blue-700 font-bold text-sm px-6 py-3 rounded-xl hover:bg-blue-50 transition-colors shadow-md whitespace-nowrap">
                        Daftar Sekarang
                    </a>
                </div>
            </div>
